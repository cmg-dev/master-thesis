...
SETZOOM="centerx=at(fn,index+1,3);\
    centery=at(fn, index+1,4);\
...
#NORM0="3:4:($1-A0_min)/(A0_max-A0_min)"
#NORM1="3:4:($1-A1_min)/(A1_max-A1_min)"
#NORM2="3:4:($1-A2_min)/(A2_max-A2_min)"
#NORM3="3:4:($1-A3_min)/(A3_max-A3_min)"
#NORM4="3:4:($1-A4_min)/(A4_max-A4_min)"
#NORM5="3:4:($1-A5_min)/(A5_max-A5_min)"
#NORM6="3:4:($1-A6_min)/(A6_max-A6_min)"
#NORM7="3:4:($1-A7_min)/(A7_max-A7_min)"
#NORM8="3:4:($1-A8_min)/(A8_max-A8_min)"
#NORM9="3:4:($1-A9_min)/(A9_max-A9_min)"
#NORM10="3:4:($1-A10_min)/(A10_max-A10_min)"
#NORM11="3:4:($1-A11_min)/(A11_max-A11_min)"
#NORM12="3:4:($1-A12_min)/(A12_max-A12_min)"
#NORM13="3:4:($1-A13_min)/(A13_max-A13_min)"
#NORM14="3:4:($1-A14_min)/(A14_max-A14_min)"
##NORM15="3:4:($1-A15_min)/(A15_max-A15_min)+A15_min"

NORM0="3:4:($1-A0_min)/(A0_max-A0_min)+A0_min"
NORM1="3:4:($1-A1_min)/(A1_max-A1_min)+A1_min"
NORM2="3:4:($1-A2_min)/(A2_max-A2_min)+A2_min"
NORM3="3:4:($1-A3_min)/(A3_max-A3_min)+A3_min"
NORM4="3:4:($1-A4_min)/(A4_max-A4_min)+A4_min"
NORM5="3:4:($1-A5_min)/(A5_max-A5_min)+A5_min"
NORM6="3:4:($1-A6_min)/(A6_max-A6_min)+A6_min"
NORM7="3:4:($1-A7_min)/(A7_max-A7_min)+A7_min"
NORM8="3:4:($1-A8_min)/(A8_max-A8_min)+A8_min"
NORM9="3:4:($1-A9_min)/(A9_max-A9_min)+A9_min"
NORM10="3:4:($1-A10_min)/(A10_max-A10_min)+A10_min"
NORM11="3:4:($1-A11_min)/(A11_max-A11_min)+A11_min"
NORM12="3:4:($1-A12_min)/(A12_max-A12_min)+A12_min"
NORM13="3:4:($1-A13_min)/(A13_max-A13_min)+A13_min"
NORM14="3:4:($1-A14_min)/(A14_max-A14_min)+A14_min"
NORM15="3:4:($1-A15_min)/(A15_max-A15_min)+A15_min"


plot f1 u @NORM0 with image, "data/processed/1.dat"  w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f1 u 3:4:( ($1==(A0_min)) ? "+" : "" ) with labels
plot f2 u @NORM1 with image, "data/processed/2.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f2 u 3:4:( ($1==(A1_min)) ? "+" : "" ) with labels
plot f3 u @NORM2 with image, "data/processed/3.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f3 u 3:4:( ($1==(A2_min)) ? "+" : "" ) with labels
plot f4 u @NORM3 with image, "data/processed/4.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f4 u 3:4:( ($1==(A3_min)) ? "+" : "" ) with labels
plot f5 u @NORM4 with image, "data/processed/5.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f5 u 3:4:( ($1==(A4_min)) ? "+" : "" ) with labels
plot f6 u @NORM5 with image, "data/processed/6.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f6 u 3:4:( ($1==(A5_min)) ? "+" : "" ) with labels
plot f7 u @NORM6 with image, "data/processed/7.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f7 u 3:4:( ($1==(A6_min)) ? "+" : "" ) with labels
plot f8 u @NORM7 with image, "data/processed/8.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f8 u 3:4:( ($1==(A7_min)) ? "+" : "" ) with labels
plot f9 u @NORM8 with image, "data/processed/9.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f9 u 3:4:( ($1==(A8_min)) ? "+" : "" ) with labels
plot f10 u @NORM9 with image, "data/processed/10.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f10 u 3:4:( ($1==(A9_min)) ? "+" : "" ) with labels
plot f11 u @NORM10 with image, "data/processed/11.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f11 u 3:4:( ($1==(A10_min)) ? "+" : "" ) with labels
plot f12 u @NORM11 with image, "data/processed/12.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f12 u 3:4:( ($1==(A11_min)) ? "+" : "" ) with labels
plot f13 u @NORM12 with image, "data/processed/13.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f13 u 3:4:( ($1==(A12_min)) ? "+" : "" ) with labels
plot f14 u @NORM13 with image, "data/processed/14.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f14 u 3:4:( ($1==(A13_min)) ? "+" : "" ) with labels
plot f15 u @NORM14 with image, "data/processed/15.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
     f15 u 3:4:( ($1==(A14_min)) ? "+" : "" ) with labels
#plot f16 u @NORM15 with image, "data/processed/16.dat" w l lt -1 lw 1 lc rgb "#2f4f4f",\
#     f16 u 3:4:( ($1==(A15_min)) ? "+" : "" ) with labels
