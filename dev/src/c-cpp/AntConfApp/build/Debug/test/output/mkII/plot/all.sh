...
./plot.sh -f E16 -s 0 -e 200 -a 8 -t 1 -p no -c yes && \ 
./plot.sh -f E17 -s 0 -e 200 -a 9 -t 1 -p no -c yes && \
./plot.sh -f E18 -s 0 -e 200 -a 9 -t 1 -p no -c yes && \
./plot.sh -f E19 -s 0 -e 200 -a 9 -t 1 -p no -c yes && \
./plot.sh -f E20 -s 0 -e 200 -a 9 -t 1 -p no -c yes && \
./plot.sh -f E21 -s 0 -e 200 -a 9 -t 1 -p no -c yes && \
./plot.sh -f E22 -s 0 -e 200 -a 9 -t 1 -p no -c yes && \
./plot.sh -f E23 -s 0 -e 200 -a 9 -t 1 -p no -c yes && \
...
./plot.sh -f E40 -s 0 -e 200 -a 9 -t 1 -p no -c yes
