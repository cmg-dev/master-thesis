...
for(( i=$START; i < $STOP;i++ )) {
    ...
    echo "****"
    #tar -C $i -xzf ../store/E$i.tar.gz data/ SigmaStats.dat VectorStats.dat EvaluationStats.dat FitnessStats.dat ObjectivStats.dat  
    tar -C $i -xzf ../store/E$i.tar.gz data/ 
