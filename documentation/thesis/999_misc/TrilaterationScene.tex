...
%	\draw[gray, very thin, dotted] (-2,-2) grid (13,10);
	...
	\draw[ -latex,violet!60,font=\scriptsize,dashed] (REF_0) -- node[sloped,above,midway] {$d_{10}$}(Int1);
	\draw[ -latex,violet!60,font=\scriptsize,dashed] (REF_0) -- node[sloped,above,midway] {$d_{20}$}(Int2);
	\draw[ -latex,violet!60,font=\scriptsize,dashed] (REF_0) -- node[sloped,above,midway] {$d_{30}$}(Int3);
