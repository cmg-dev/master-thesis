...
Dort wird auch das Flag \textit{CAN\_PROPOSE\_STARTING\_POINT} gesetzt.% Eigenschaft hat in c++ und generell in OOP eine andere Bedeutung
Sie wird von den unterschiedlichen Optimizern verwendet, um zu erkennen, welche Features vom Modell unterstützt werden.
% Listing ist redundant, ich würde einfach auf "den Konstruktor" verweisen
...
%
%
\subsubsection{Process MkII -- Finde die Lösung} % Ich würde den Untertitle weglassen, oder "Finden der Lösung"
%
