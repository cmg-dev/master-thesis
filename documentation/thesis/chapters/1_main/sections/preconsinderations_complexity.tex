...
\end{floatingfigure}
%
In diesem Abschnitt wird eine Betrachtung der Komplexität des Problems gegeben. Bereits in Kapitel~\ref{sec:tech_preliminaries} wurde auf die Komplexität eingegangen. Hier werden Erkenntnisse präsentiert, die auf das Basis realer Messdaten ein Gefühl für die Komplexität geben sollen. In einem späteren Abschnitt~\ref{fig:Complexity2} wird das Entwickelte Modell analysiert, dazu sind die Einsichten aus diesem Abschnitt eine Orientierungshilfe.\\
%
