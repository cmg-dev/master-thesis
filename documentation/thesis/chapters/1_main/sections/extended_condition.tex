...
\item Die Konditionszahl der \textit{schlechtesten} Konfiguration ist wesentlich kleiner (ca. Faktor $10$) als im rein geometrischen Modell % bin mir nicht sicher
\end{enumerate}
%
\begin{figure}[h!]
         \centering
