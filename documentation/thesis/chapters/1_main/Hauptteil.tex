...
\input{chapters/1_main/sections/preconsinderations_complexity.tex}
%
%---------------------------------------------------------------------
\section{Entwicklung des Modells}
\label{sec:model_developement}
% "Modell für die Lösung des Zusammenhangs" klingt für mich sehr komisch
...
%
\input{chapters/1_main/sections/model.tex}
%
%---------------------------------------------------------------------
\section{Antennen Permutationen}
\input{chapters/1_main/sections/permutations.tex}
%
%---------------------------------------------------------------------
\section{Erweiterte Betrachtung der Kondition}
%
\label{sec:ExtendedContidion}
\input{chapters/1_main/sections/extended_condition.tex}
%
%---------------------------------------------------------------------
...
\input{chapters/1_main/sections/analyzing_complexity.tex}
%
%---------------------------------------------------------------------
...
%
\input{chapters/1_main/sections/calibration.tex}
%
%---------------------------------------------------------------------
\section{Software}
\label{sec:sw}
\input{chapters/1_main/sections/software.tex}
