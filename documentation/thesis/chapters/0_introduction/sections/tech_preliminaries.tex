...
\begin{figure}[h]
         \centering
         \caption[PRPS der \amedogmbh - acht Antennen]{Abgebildet ist der Messaufbau mit unterschiedlichen Antennen. Der Aufbau ist auf ein Messvolumina von mehreren Kubikmetern ausgerichtet}
		\label{fig:Setup}
		\vspace{2mm}
