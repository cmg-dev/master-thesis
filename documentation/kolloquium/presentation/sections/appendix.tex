...
%------------------------------------------------------
\begin{frame}[noframenumbering]
  \frametitle{Unterbrochene Evol. Kalibrierung}
  \begin{center}
  \includegraphics[width=.47\textwidth]{../img/aborted_calibration_ant0-boxes.png}
  \qquad
  \includegraphics[width=.47\textwidth]{../img/aborted_calibration_ant0-lines.png}
  \end{center}
\end{frame}
%------------------------------------------------------
\begin{frame}[noframenumbering]
